...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_pub_sub_SOURCE_PREFIX /home/mrmovement/demo2_ws/src/plumbing_pub_sub)
  set(plumbing_pub_sub_DEVEL_PREFIX /home/mrmovement/demo2_ws/devel)
  ...
  set(plumbing_pub_sub_INSTALL_PREFIX /home/mrmovement/demo2_ws/install)
...
if(NOT "/home/mrmovement/demo2_ws/devel/include " STREQUAL " ")
  set(plumbing_pub_sub_INCLUDE_DIRS "")
  set(_include_dirs "/home/mrmovement/demo2_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_pub_sub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mrmovement/demo2_ws/src/plumbing_pub_sub/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mrmovement/demo2_ws/devel/lib;/opt/ros/noetic/lib)
