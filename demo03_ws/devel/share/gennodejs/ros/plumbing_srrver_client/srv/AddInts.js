...
// (in-package plumbing_srrver_client.srv)
...
class AddIntsRequest {
  ...
  static datatype() {
    ...
    return 'plumbing_srrver_client/AddIntsRequest';
  }
...
class AddIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'plumbing_srrver_client/AddIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'plumbing_srrver_client/AddInts'; }
};
